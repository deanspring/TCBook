...
public class DataExtractionJob {
    ...
    protected static void retriveDataOfTheArtist(EchoNestAPI echonest, MusicalArtist artist, String artistName)
        ...
        log.info("[DATA_EXTRACTION_JOB] Extracting data of artist {}", artist);
    ...
    private static void extractLastFMData(MusicalArtist artist, String artistName, String apiKey, EchoNestAPI echonest) {
        try {
            ...
            log.info("[DATA_EXTRACTION_JOB] Abour to extract lastfm data of artist {}", artist);
            ...
            if (!foundArtist(remoteMbid)) {
                ...
                log.info("[DATA_EXTRACTION_JOB] Not found data in lastfm, about to retrieve data of artist from echonest. {}", artist);
                ...
                if (echoNestArtist != null) {
                    ...
                    log.info("[DATA_EXTRACTION_JOB] Found data {} in echonest", echoNestArtist);
    ...
    private static void extractRegionData(EchoNestAPI echonest, String remoteName, MusicalArtist artist) {
        ...
        log.info("[DATA_EXTRACTION_JOB] About to extract region data for artist {}", artist);
    ...
    protected static void createRegionAndUpdateArtist(MusicalArtist artist, StringBuilder logText, Artist echonestArtist) {
        try {
            ...
            String remoteCity = null;
            String remoteCountry = null;
            ...
            while (!extracted) {
                try {
                    ...
                    if (location != null) {
                        remoteCity = location.getCity();
                        remoteCountry = location.getCountry();
                    }

                    extracted = true;
                } catch (EchoNestException e) {
                    log.error("Echonest requests limit exceeded. Will retry...");
                    try {
                        Thread.sleep(10000);
            ...
            log.info("[DATA_EXTRACTION_JOB] Extracted region data for artist {}", artist);
